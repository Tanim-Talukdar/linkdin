...
import { userDetail } from "@/config/redux/action/authAction";
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-10 px-4 sm:px-6 lg:px-8 space-y-6">
      ...
      >
        ...
        <div className="flex space-x-3">
          <button className="bg-teal-500 hover:bg-teal-600 text-white px-5 py-2 rounded-xl shadow-md font-medium">
            Connect
          </button>
